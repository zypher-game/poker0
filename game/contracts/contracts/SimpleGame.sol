...
contract SimpleGame is RoomMarket {
  ...
  constructor(address _token, uint256 _minStaking, uint256 _playerRoomLock, uint256 _playerLimit, uint256 _startRoomId) RoomMarket(_token, _minStaking, _playerRoomLock, _playerLimit, _startRoomId) {}
